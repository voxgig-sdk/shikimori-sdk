...
The PHP SDK for the Shikimori API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Achievement(null)->list(null, null);
...
[$result, $err] = $client->Shikimori(null)->load(
    ["id" => "test01"], null
);
