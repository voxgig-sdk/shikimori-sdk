...
class ShikimoriGraphql
{
    ...
    // equivalent.
    public static function body(ShikimoriContext $ctx): mixed
    {
    ...
    public static function errors(ShikimoriContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
