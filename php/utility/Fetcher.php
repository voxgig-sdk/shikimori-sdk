...
// Shikimori SDK utility: fetcher

class ShikimoriFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShikimoriSDK/1.0)';
    ...
    public static function call(ShikimoriContext $ctx, string $fullurl, array $fetchdef): array
    {
