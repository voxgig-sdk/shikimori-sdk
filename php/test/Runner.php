...
class ShikimoriTestRunner
{
    ...
    {
        $live = self::getenv('SHIKIMORI_TEST_LIVE');
        $override = self::getenv('SHIKIMORI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SHIKIMORI_TEST_EXPLAIN');
...
class_alias('ShikimoriTestRunner', 'Runner');
class_alias('ShikimoriHelpers', 'Helpers');
