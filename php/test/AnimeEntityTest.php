...
class AnimeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHIKIMORI_TEST_ANIME_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function anime_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHIKIMORI_TEST_ANIME_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["SHIKIMORI_TEST_ANIME_ENTID"]);
