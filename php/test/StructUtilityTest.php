...
// Shikimori SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ShikimoriOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ShikimoriOmni::structfix($now, Struct::undef()))
                        !== json_encode(ShikimoriOmni::structfix($val, Struct::undef()))) {
