...
// Shikimori SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShikimoriSDK::test)
...
{
    private const SDK_CLASS = 'ShikimoriSDK';
    ...
    private const SDK_BASE = 'shikimori_sdk';
