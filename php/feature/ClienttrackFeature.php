...
// Shikimori SDK clienttrack feature
...
class ShikimoriClienttrackFeature extends ShikimoriBaseFeature
{
    ...
    public function PostConstruct(ShikimoriContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Shikimori-SDK';
