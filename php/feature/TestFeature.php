...
// Shikimori SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ShikimoriTestFeature extends ShikimoriBaseFeature
{
    ...
    public function init(ShikimoriContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ShikimoriContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ShikimoriParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ShikimoriContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ShikimoriContext $ctx, $op, $args): array
    {
