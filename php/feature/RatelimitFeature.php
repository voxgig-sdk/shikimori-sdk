...
// Shikimori SDK ratelimit feature
...
class ShikimoriRatelimitFeature extends ShikimoriBaseFeature
{
    ...
    private function _acquire(ShikimoriContext $ctx): void
    {
    ...
    private function _track(ShikimoriContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
