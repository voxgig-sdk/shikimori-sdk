...
class ShikimoriProxyFeature extends ShikimoriBaseFeature
{
    ...
    public function init(ShikimoriContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShikimoriContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
