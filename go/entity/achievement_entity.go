...
import (
	...
	vs "github.com/voxgig-sdk/shikimori-sdk/go/utility/struct"
)

type AchievementEntity struct {
	name    string
	client  *core.ShikimoriSDK
...
func NewAchievementEntity(client *core.ShikimoriSDK, entopts map[string]any) *AchievementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AchievementEntity) GetName() string { return e.name }
...
func (e *AchievementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AchievementEntity) Deleted() bool {
	return e.deleted
}


func (e *AchievementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAchievementEntity(e.client, opts)
}

func (e *AchievementEntity) Data(args ...any) any {
...
func (e *AchievementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Achievement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AchievementEntity) DataTyped(data ...Achievement) Achievement {
	if len(data) > 0 {
		return typedFrom[Achievement](e.Data(asMap(data[0])))
	}
	return typedFrom[Achievement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Achievement (all fields
// optional at the wire level).
func (e *AchievementEntity) MatchTyped(match ...Achievement) Achievement {
	if len(match) > 0 {
		return typedFrom[Achievement](e.Match(asMap(match[0])))
	}
	return typedFrom[Achievement](e.Match())
}
...
func (e *AchievementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AchievementEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AchievementEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AchievementListMatch and returns []Achievement. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AchievementEntity) ListTyped(reqmatch AchievementListMatch, ctrl map[string]any) ([]Achievement, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Achievement](res), nil
}



func (e *AchievementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AchievementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AchievementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AchievementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
