...
const testSeed = `map[string]any{"entity": map[string]any{"achievement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "anime": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
