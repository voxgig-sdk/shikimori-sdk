...
func (sdk *ShikimoriSDK) OptionsMap() map[string]any {
...
func (sdk *ShikimoriSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ShikimoriSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ShikimoriSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ShikimoriSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ShikimoriSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ShikimoriSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ShikimoriSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ShikimoriSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ShikimoriSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ShikimoriSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
