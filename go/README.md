...
The Golang SDK for the Shikimori API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/shikimori-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/shikimori-sdk=../path/to/github.com/voxgig-sdk/shikimori-sdk
```
...
| `Achievement` | `(data map[string]any) ShikimoriEntity` | Create a Achievement entity instance. |
| `Anime` | `(data map[string]any) ShikimoriEntity` | Create a Anime entity instance. |
...
```
github.com/voxgig-sdk/shikimori-sdk/
...
The root package (`github.com/voxgig-sdk/shikimori-sdk`) re-exports everything needed
