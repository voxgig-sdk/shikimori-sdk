...
from projectname_sdk import ShikimoriSDK
from projectname_sdk.core.spec import ShikimoriSpec
from projectname_sdk.core.result import ShikimoriResult
from projectname_sdk.core.response import ShikimoriResponse
from projectname_sdk.core.operation import ShikimoriOperation
from projectname_sdk.core.error import ShikimoriError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ShikimoriBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ShikimoriError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ShikimoriSDK.test(None, None)
        ...
        class TestInitFeature(ShikimoriBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ShikimoriBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ShikimoriSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ShikimoriSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ShikimoriSDK.test(None, setup_opts)
