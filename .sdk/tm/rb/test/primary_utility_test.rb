...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ShikimoriOmni.make_runner(TEST_JSON_FILE, ShikimoriSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ShikimoriOmni.errify(err)
    end
