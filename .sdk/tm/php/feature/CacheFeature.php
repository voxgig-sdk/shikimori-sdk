...
class ShikimoriCacheFeature extends ShikimoriBaseFeature
{
    ...
    private function _through(ShikimoriContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
