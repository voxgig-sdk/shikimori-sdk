...
class ShikimoriTimeoutFeature extends ShikimoriBaseFeature
{
    ...
    private function _with_timeout(ShikimoriContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShikimoriContext $_ctx, float $ms): void
    {
        $client = $this->client;
