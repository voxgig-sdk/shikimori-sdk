...
class ShikimoriRbacFeature extends ShikimoriBaseFeature
{
    ...
    private function _required(ShikimoriContext $ctx): ?string
    {
    ...
    private function _reject(ShikimoriContext $ctx, string $required): void
    {
    ...
    private function _track(ShikimoriContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
