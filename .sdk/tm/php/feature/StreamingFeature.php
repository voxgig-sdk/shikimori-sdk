...
// Shikimori SDK streaming feature
...
class ShikimoriStreamingFeature extends ShikimoriBaseFeature
{
    ...
    private function _iterate(ShikimoriResult $result): \Generator
    {
    ...
    private function _streamable(ShikimoriContext $ctx): bool
    {
