...
// Shikimori SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ShikimoriMakeRequest
{
    public static function call(ShikimoriContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ShikimoriResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ShikimoriResponse($fetched);
        } else {
