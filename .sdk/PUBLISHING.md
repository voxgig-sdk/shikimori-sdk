...
|---|---|---|
| `ts/` | @voxgig-sdk/shikimori-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/shikimori-sdk \
      --repository voxgig-sdk/shikimori-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/shikimori-sdk` shows it, and
`npm trust revoke @voxgig-sdk/shikimori-sdk --id=<id>` removes it.
