...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/shikimori` | `npm install @voxgig-sdk/shikimori` |
| Python | `voxgig-sdk-shikimori` | `pip install voxgig-sdk-shikimori` |
| PHP | `voxgig-sdk/shikimori` | `composer require voxgig-sdk/shikimori` |
| Golang | `github.com/voxgig-sdk/shikimori-sdk/go` | `go get github.com/voxgig-sdk/shikimori-sdk/go` |
| Ruby | `voxgig-sdk-shikimori` | `gem install voxgig-sdk-shikimori` |
| Lua | `voxgig-sdk-shikimori` | `luarocks install voxgig-sdk-shikimori` |
