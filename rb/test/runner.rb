...
module ShikimoriTestRunner
  ...
  def self.env_override(m)
    live = getenv("SHIKIMORI_TEST_LIVE")
    override = getenv("SHIKIMORI_TEST_OVERRIDE")
    ...
    explain = getenv("SHIKIMORI_TEST_EXPLAIN")
    m["SHIKIMORI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ShikimoriTestRunner
Helpers = ShikimoriHelpers
Vs = VoxgigStruct
