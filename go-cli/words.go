...
func registerSDKWords(r *eng.Registry, client *sdk.ShikimoriSDK) {
...
func runOp(client *sdk.ShikimoriSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
