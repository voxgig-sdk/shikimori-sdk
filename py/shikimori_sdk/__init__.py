...
from shikimori_sdk.utility import register

# Load features
from shikimori_sdk.feature.base_feature import ShikimoriBaseFeature
from shikimori_sdk.features import _has_feature, _make_feature
...
class ShikimoriSDK:
    ...
    def get_utility(self):
        return ShikimoriUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ShikimoriSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Achievement(self, data=None) -> "AchievementEntity":
        ...
        from shikimori_sdk.entity.achievement_entity import AchievementEntity
    ...
    def Anime(self, data=None) -> "AnimeEntity":
        ...
        from shikimori_sdk.entity.anime_entity import AnimeEntity
