# Shikimori SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShikimoriSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShikimoriSDK(...) and ShikimoriSDK.test(...) become
#      ShikimoriSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shikimori_sdk"
_SDK_CLASS = "ShikimoriSDK"
