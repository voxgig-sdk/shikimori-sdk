...
(0, node_test_1.describe)('AchievementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ShikimoriSDK({
    ...
    (0, node_test_1.test)('direct-list-achievement', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-achievement', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SHIKIMORI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ShikimoriSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.SHIKIMORI_APIKEY,
        }));
        let idmap = env['SHIKIMORI_TEST_ACHIEVEMENT_ENTID'];
    ...
    const client = new __1.ShikimoriSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AchievementDirect.test.js.map