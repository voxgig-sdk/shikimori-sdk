...
function envOverride(m) {
    if ('TRUE' === process.env.SHIKIMORI_TEST_LIVE ||
        'TRUE' === process.env.SHIKIMORI_TEST_OVERRIDE) {
    ...
    m.SHIKIMORI_TEST_EXPLAIN = process.env.SHIKIMORI_TEST_EXPLAIN || m.SHIKIMORI_TEST_EXPLAIN;
    return m;
}
