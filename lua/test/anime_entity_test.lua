...
describe("AnimeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHIKIMORI_TEST_ANIME_ENTID JSON to run live")
      return
    end
...
function anime_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHIKIMORI_TEST_ANIME_ENTID")
