...
describe("AchievementDirect", function()
  it("should direct-list-achievement", function()
    local setup = achievement_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-achievement", setup.live and "live" or "unit")
...
function achievement_direct_setup(mockres)
