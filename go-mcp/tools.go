...
type Args struct {
	Entity string         `json:"entity" jsonschema:"achievement | anime"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ShikimoriSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "shikimori_list",
		Description: "List records from Shikimori. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "shikimori_load",
		Description: "Load a single record from Shikimori. " +
...
func runOp(client *sdk.ShikimoriSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ShikimoriSDK, name string) (sdk.ShikimoriEntity, error) {
